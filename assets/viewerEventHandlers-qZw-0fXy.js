const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TemporalEchoController-CWYSM1el.js","assets/main-DiqBh08p.js","assets/main-v701mYTx.css","assets/MinimalistAudioEngine-TrDE3bL-.js","assets/HapticManager-mSV16L9a.js","assets/MultimodalSyncEngine-CQZ5SsbH.js"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { O as OpenSeadragon, _ as __vitePreload, i as isMobile, d as OverlayManagerFactory } from "./main-DiqBh08p.js";
import { c as createLogger, o as organicVariations, C as CentralizedEventManager, p as performanceConfig, a as adjustSettingsForPerformance } from "./viewerSetup-DWJCyMmX.js";
...
async function initializeHotspotSystem(viewer, state, componentsObj, handleHotspotClick, hotspotData) {
  ...
  if (renderer.eventCoordinator) {
    const TemporalEchoController = (await __vitePreload(async () => {
      const { default: __vite_default__ } = await import("./TemporalEchoController-CWYSM1el.js");
    ...
    if (isMobile()) {
      const MinimalistAudioEngine = (await __vitePreload(async () => {
        const { default: __vite_default__ } = await import("./MinimalistAudioEngine-TrDE3bL-.js");
        return { default: __vite_default__ };
      ...
      const initAudioOnInteraction = async () => {
        try {
          ...
          const { getMultimodalSyncEngine } = await __vitePreload(async () => {
            const { getMultimodalSyncEngine: getMultimodalSyncEngine2 } = await import("./MultimodalSyncEngine-CQZ5SsbH.js");

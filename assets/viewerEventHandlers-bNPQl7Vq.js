const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TemporalEchoController-CVE23dZz.js","assets/main-C9PBdCor.js","assets/main-DTOzWaBI.css","assets/MinimalistAudioEngine-BfU_4B_u.js","assets/HapticManager-BbDSbiBA.js","assets/MultimodalSyncEngine-YdebBQu2.js"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { O as OpenSeadragon, _ as __vitePreload, i as isMobile, d as OverlayManagerFactory } from "./main-C9PBdCor.js";
import { c as createLogger, o as organicVariations, p as performanceConfig, a as adjustSettingsForPerformance } from "./viewerSetup-BaHjSwan.js";
      ...
      if (clickedHotspot) {
        ...
        if (isMobileWithCanvas) {
          ...
          if (isRevealed) {
            ...
            if ((_a = window.minimalistAudioEngine) == null ? void 0 : _a.isUnlocked) {
              window.minimalistAudioEngine.playActivate();
              console.log("[NativeHotspotRenderer] Played activate sound for hotspot:", clickedHotspot.id);
            }
...
async function initializeHotspotSystem(viewer, state, componentsObj, handleHotspotClick, hotspotData) {
  ...
  if (renderer.eventCoordinator) {
    const TemporalEchoController = (await __vitePreload(async () => {
      const { default: __vite_default__ } = await import("./TemporalEchoController-CVE23dZz.js");
    ...
    if (isMobile()) {
      const MinimalistAudioEngine = (await __vitePreload(async () => {
        const { default: __vite_default__ } = await import("./MinimalistAudioEngine-BfU_4B_u.js");
        return { default: __vite_default__ };
      ...
      const initAudioOnInteraction = async () => {
        try {
          ...
          const { getMultimodalSyncEngine } = await __vitePreload(async () => {
            const { getMultimodalSyncEngine: getMultimodalSyncEngine2 } = await import("./MultimodalSyncEngine-YdebBQu2.js");

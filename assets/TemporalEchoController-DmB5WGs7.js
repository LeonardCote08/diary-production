import { O as OpenSeadragon, i as isMobile, f as getDefaultExportFromCjs, c as commonjsGlobal } from "./main-CUTk6aOB.js";
const GestureStates = {
  IDLE: "idle",
...
class TemporalEchoController {
  ...
  handleQuickTap(tapData) {
    ...
    if (window.multimodalSyncEngine) {
      ...
      if ((_c = window.minimalistAudioEngine) == null ? void 0 : _c.isUnlocked) {

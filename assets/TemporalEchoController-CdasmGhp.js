import { O as OpenSeadragon, i as isMobile, f as getDefaultExportFromCjs, h as commonjsGlobal } from "./main-CMhWozAd.js";
import "./viewerSetup-Ct0ukrPv.js";
const GestureStates = {
  IDLE: "idle",
...
class TemporalEchoController {
  ...
  handleQuickTap(tapData) {
    ...
    this.updateFPS();
    this.lastHandledTapTime = performance.now();
    return true;
  }
  /**

import { g as getHapticManager } from "./HapticManager-DYjex1_y.js";
import "./main-BKvSMc23.js";
class MultimodalSyncEngine {
  ...
  detectPlatform() {
    ...
    return {
      ...
      isAndroid,
      isSafari,
      hasVibration: "vibrate" in navigator && !isIOS,
  ...
  async scheduleHaptic(targetTime, tapData) {
    if (!this.platform.hasVibration) {
      console.log("[MultimodalSyncEngine] No vibration support, using fallback");
      return { status: "fallback", platform: "iOS" };
    }

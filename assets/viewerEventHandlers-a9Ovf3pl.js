const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TemporalEchoController-B-h1C0FR.js","assets/main-PURk3aep.js","assets/main-v701mYTx.css","assets/MinimalistAudioEngine-DjrbRckI.js","assets/HapticManager-DD-ku5JQ.js","assets/MultimodalSyncEngine-De-jCXNb.js"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { O as OpenSeadragon, _ as __vitePreload, i as isMobile, d as OverlayManagerFactory } from "./main-PURk3aep.js";
import { c as createLogger, o as organicVariations, C as CentralizedEventManager, p as performanceConfig, a as adjustSettingsForPerformance } from "./viewerSetup-23gUJZq1.js";
...
async function initializeHotspotSystem(viewer, state, componentsObj, handleHotspotClick, hotspotData) {
  ...
  if (renderer.eventCoordinator) {
    const TemporalEchoController = (await __vitePreload(async () => {
      const { default: __vite_default__ } = await import("./TemporalEchoController-B-h1C0FR.js");
    ...
    if (isMobile()) {
      const MinimalistAudioEngine = (await __vitePreload(async () => {
        const { default: __vite_default__ } = await import("./MinimalistAudioEngine-DjrbRckI.js");
        return { default: __vite_default__ };
      ...
      const initAudioOnInteraction = async () => {
        try {
          ...
          const { getMultimodalSyncEngine } = await __vitePreload(async () => {
            const { getMultimodalSyncEngine: getMultimodalSyncEngine2 } = await import("./MultimodalSyncEngine-De-jCXNb.js");
